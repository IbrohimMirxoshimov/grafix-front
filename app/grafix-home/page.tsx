...
export default function GrafixHomePage() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "Типография «Grafix» выполняет печать листовок, буклетов, брошюр, упаковки и другой полиграфии на заказ. Работы подбираются индивидуально под ваш бизнес.",
    },
  ];
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg mb-12 text-blue-200 max-w-2xl mx-auto">
              Типография полного цикла «Grafix» оказывает полиграфические услуги
              в Ташкенте по низким ценам
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            {products.map((product, index) => (
              <div
                key={index}
                className="text-center bg-white p-4 rounded-lg shadow-lg hover:shadow-xl transition-shadow cursor-pointer"
              >
                <img
                  src={product.image}
                  alt={product.title}
      ...
      >
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {portfolioCategories[activePortfolio].examples.map(
              (image, index) => (
                <div
                  key={index}
